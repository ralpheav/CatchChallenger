...
std::pair<std::vector<const tinyxml2::XMLElement*>, std::vector<Profile>> DatapackGeneralLoader::loadProfileList(
...
std::unordered_map<uint16_t, std::vector<MonsterDrops>> DatapackGeneralLoader::loadMonsterDrop(
