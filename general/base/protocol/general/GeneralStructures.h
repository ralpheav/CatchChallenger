...
struct Reputation
{
    std::vector<int32_t> reputation_positive/*start with 0*/;
    std::vector<int32_t> reputation_negative;
    /*server only*/
...
{
    /*index into CatchChallenger::CommonDatapack::commonDatapack.monstersCollision*/
    std::vector<uint32_t> walkOn;
    std::vector<uint32_t> actionOn;
