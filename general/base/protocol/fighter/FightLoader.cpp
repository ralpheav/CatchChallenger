                    ...
                    if (duplicate.find(name) == duplicate.cend())
                    {
                        ...
                        while (multiplicator != NULL)
                        {
                            if (multiplicator->Attribute(XMLCACHEDSTRING_number) != NULL && multiplicator->Attribute(XMLCACHEDSTRING_to) != NULL)
                            {
                                ...
                                if (ok
                                        && (static_cast<double>(number) == 2.0
                                        || static_cast<double>(number) == 0.5
                                        || static_cast<double>(number) == 0.0)
                                   )
                                {
                                                ...
                                                )
{
    ...
    while (file_index < (uint32_t)fileList.size())
    {
                ...
                if (!ok) {
                    ...
                    if (ok)
                    {
                        ...
                        if (ok)
                        {
                            ...
                            monster.give_xp = 0;
                            monster.give_sp = 0;
                        #endif // EPOLLCATCHCHALLENGERSERVERNOGAMESERVER
                    #endif // CATCHCHALLENGER_CLASS_MASTER
                    if (ok)
                    {
        ...
        {
            unsigned int index = 0;
            bool evolutionByLevel = false;
            bool evolutionByTrade = false;
