...
using namespace CatchChallenger;
    ...
    std::thread DatapackChecksum::thread;
    //pthread_t DatapackChecksum::pthread;
#endif
...
void DatapackChecksum::start() {
    #if ! defined(EPOLLCATCHCHALLENGERSERVER)
        if (!thread.joinable()) {
            thread = std::thread(DatapackChecksum::work);
            //thread.join();
        }
...
void DatapackChecksum::work()
{
    //call the checking with datapackPath
    //Need more info.....................
}
